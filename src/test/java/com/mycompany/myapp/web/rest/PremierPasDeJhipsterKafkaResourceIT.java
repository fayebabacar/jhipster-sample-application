...
class PremierPasDeJhipsterKafkaResourceIT {
    ...
    void setup() {
        ...
        PremierPasDeJhipsterKafkaResource kafkaResource = new PremierPasDeJhipsterKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/premier-pas-de-jhipster-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/premier-pas-de-jhipster-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
