...
@RestController
@RequestMapping("/api/premier-pas-de-jhipster-kafka")
public class PremierPasDeJhipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PremierPasDeJhipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PremierPasDeJhipsterKafkaResource(KafkaProperties kafkaProperties) {
